...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    title: `${post.title}`,
    metadataBase: new URL(`https://talhakerpicci.com/blog/${post.slug}`),
    description: post.description,
    publisher: post.author.name,
    keywords: post.tags,
    alternates: {
      canonical:
        post.canonicalLink || `https://talhakerpicci.com/blog/${post.slug}`,
    },
    openGraph: {
      images:
        fallbackImage,
      url: `https://talhakerpicci.com/blog/${post.slug}`,
      title: post.title,
      description: post.description,
      type: "article",

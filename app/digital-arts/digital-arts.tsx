            ...
            {lightboxOpen && (
                ...
                >
                    ...
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2" onClick={(e) => e.stopPropagation()}>
                        <BiLeftArrowAlt size={50} onClick={nextImage} className="text-white text-3xl cursor-pointer" />
                    </div>
                    <img
                        style={{ opacity: opacity, maxWidth: '90vw', maxHeight: '90vh' }}
                    ...
                    <div className="absolute right-4 top-1/2 transform -translate-y-1/2" onClick={(e) => e.stopPropagation()}>
                        <BiRightArrowAlt size={50} onClick={prevImage} className="text-white text-3xl cursor-pointer" />
                    </div>
